...
where domain_id = 'Drug' and
  ...
  (
    ...
    concept_name like '%metformin%' or -- metformin
    ...
    concept_name like '%gilfor%' or
    concept_name like '%glycon%' or
    concept_name like '%janumet%' or
    concept_name like '%velmetia%'
  ) and (
    -- Exclude false positives
    concept_name not like '%cobimetinib%' and
    concept_name not like '%aglycone%'
  )
